...
\begin{center}
    ...
    \href{https://www.linkedin.com/in/jgalego/}{linkedin.com/in/jgalego} $|$ \faGithubSquare~\href{https://github.com/JGalego}{\texttt{github.com/JGalego}} $|$ 
    \faGlobe~\href{https://jgalego.github.io}{jgalego.github.io}
\end{center}
...
\justifying João Galego is Head of AI at Critical Software and Invited Professor at Instituto Superior de Economia e Gestão (ISEG). He majored in Physics at Instituto Superior Técnico (IST) in Lisbon and obtained a postgraduate diploma in Forensic Studies from Instituto Superior de Ciências Sociais (ISCSP). He did doctoral work in Cognitive Science at ULisboa, where he used machine learning (ML) to decode complex brain patterns and study motor cognition. Prior to joining Critical Software, João served as Lead ML Engineer at Siemens and held roles as Solutions Architect, ML Specialist, and Quantum Ambassador at AWS. At Critical Software, his mission is to bring AI to high-stakes domains and build ML that matters. When he is not working or teaching, you can usually find him browsing local bookstores, contributing to open-source projects, or enjoying quality time with his family.
  ...
  \resumeSubHeadingListStart
    ...
    \vspace{2mm}
        \begin{itemize}
            ...
            \item Reponsible for deploying models into production while ensuring the highest standards in data integrity
...
\section{Education}
  \resumeSubHeadingListStart
    \vspace{2mm}
    \resumeSubheading
      {PhD Cognitive Science \textcolor{red}{(ABD)}}{2017 -- 2021}
    ...
    \resumeSubheading
      {PgD Forensic Studies \emoji{graduation-cap}}{2016 -- 2017}
    ...
    \resumeSubheading
      {MSc Physics \emoji{graduation-cap}}{2008 -- 2013}
...
\href{https://www.credly.com/badges/be89049c-bdf4-43c9-9c54-dbc93c1fec96}{\includegraphics[height=\badge_height]{images/aws_sa_associate}}
\href{https://www.credly.com/badges/db8f9c80-1b4f-4fe3-994e-038d787425be}{\includegraphics[height=\badge_height]{images/aws_sa_professional}}
\href{https://www.credly.com/badges/ecbd3b46-9ab1-4b69-a0eb-5aa4fb66edd0}{\includegraphics[height=\badge_height]{images/aws_ml_specialty}}
\href{https://www.credly.com/badges/1eead9ca-acd6-4ab9-b402-c2e4d2f030d5}{\includegraphics[height=\badge_height]{images/aws_database_specialty}}
\href{https://www.credly.com/badges/6822536f-d65a-437c-8fed-4db09a6946dd/public_url}{\includegraphics[height=\badge_height]{images/aws_partner_accreditation_technical.png}}
\href{https://www.credly.com/badges/4bda2e2a-1b4c-4a02-807c-a7ebc7f712de}{\includegraphics[height=\badge_height]{images/aws_partner_accreditation_cloud_economics.png}}
%-- TODO: update Migration Ambassador badge link --
\href{https://www.credly.com/org/amazon-web-services/badge/migration-ambassador-foundations-business-2022}{\includegraphics[height=\badge_height]{images/aws_migration_ambassador_foundations_2022_business.png}}
\href{https://www.credly.com/badges/ecbd3b46-9ab1-4b69-a0eb-5aa4fb66edd0}{\includegraphics[height=\badge_height]{images/google_certs_da}}
\href{https://developers.google.com/certification/associate-android-developer}{\includegraphics[height=\badge_height]{images/certified_android_developer}}
\href{https://www.credly.com/badges/8b9deb9d-34be-4ae5-b76c-b76cc2ec8381}{\includegraphics[height=\badge_height]{images/azure_fundamentals}}
\href{https://www.credly.com/badges/ce2d880c-1faf-4047-bc91-d3cd5d60a8eb}{\includegraphics[height=\badge_height]{images/ibm_neuro_symbolic_ai_essentials}}
\href{https://www.credly.com/badges/16334ec2-f99f-4370-803e-ae8e4ea94a98}{\includegraphics[height=\badge_height]{images/ibm_quantum_challenge_fall_2022}}
\href{https://www.credly.com/badges/9e2e2bae-d10d-4e3a-aa13-e95a35e8f8c3}{\includegraphics[height=\badge_height]{images/ibm_quantum_challenge_spring_2023}}
%\href{https://www.cloudbees.com/jenkins/certification}{\includegraphics[height=\badge_height]{images/cje_2016}}

\resumeSubHeadingListStart
    \vspace{2mm}
    \resumeSubheading
      {\href{https://www.oxfordml.school/}{Oxford Machine Learning Summer School}}{2025}
      {AI for Global Goals}{}
    \vspace{2mm}
    ...
    \vspace{2mm}
    \resumeSubheading
      {\href{https://www.oxfordml.school/}{Oxford Machine Learning Summer School}}{2024}
      {AI for Global Goals}{}
    \vspace{2mm}
    ...
    \vspace{2mm}
    \resumeSubheading
      {\href{https://www.oxfordml.school/}{Oxford Machine Learning Summer School}}{2022}
      {AI for Global Goals}{}
    \vspace{2mm}
    ...
    \resumeSubheading
      {\href{startupschool.org/}{Startup School}}{2022}
      {Y Combinator}{}
    \vspace{2mm}
    ...
    Multi-course specialization on how to \emph{productionize} ML applications, organized in collaboration with \href{https://www.deeplearning.ai/}{DeepLearning.AI} and the Google \href{https://www.tensorflow.org/}{TensorFlow} team.
    ...
    Entry-level exam that includes a coding project and exit interview, covering topics related to app functionality, UI and data management, as well as debugging and testing of Android apps. % cf. \href{https://developers.google.com/certification/associate-android-developer/study-guide}{Associate Android Developer study guide} for additional information.
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \begin{itemize}
        \item \textbf{Automation} -
            \href{https://www.redhat.com/en/technologies/management/ansible}{Ansible},
            \href{https://www.packer.io/}{Packer}, \href{https://www.terraform.io/}{Terraform},
            \href{https://www.vagrantup.com/}{Vagrant}
        \item \textbf{CI/CD} - 
            \href{https://docs.microsoft.com/en-us/azure/devops}{Azure DevOps},
            \href{https://docs.gitlab.com/ee/ci/}{GitLab CI}, 
            \href{https://www.jenkins.io/}{Jenkins}
        \item \textbf{Containerization} - 
            \href{https://www.docker.com/}{Docker}, 
            \href{https://kubernetes.io/}{Kubernetes}
        \item \textbf{Logging \& Monitoring} - 
            \href{https://www.elastic.co/elastic-stack/}{Elastic (ELK) Stack},
            \href{https://grafana.com/grafana/}{Grafana}
        \item \textbf{Package Management} - 
            \href{https://jfrog.com/artifactory/}{JFrog Artifactory} 
        ...
        \item \textbf{Virtualization} - 
            ...
            \href{https://www.vmware.com/}{VMware}
    \end{itemize}
    
    \item Extensive experience with common Python packages for scientific computing (\href{https://numpy.org/}{NumPy}, \href{https://www.scipy.org/}{SciPy}), data analysis (\href{https://pandas.pydata.org/}{Pandas}, \href{https://github.com/vaexio/vaex}{Vaex}) and differentiable programming (\href{https://jax.readthedocs.io/en/latest/index.html}{JAX}, \href{https://mxnet.apache.org/versions/1.8.0/}{MXNet}, \href{https://pytorch.org/}{PyTorch}, \href{https://www.tensorflow.org/}{TensorFlow}), NLP modules (\href{https://radimrehurek.com/gensim/}{Gensim}, \href{https://www.nltk.org/}{NLTK}, \href{https://spacy.io/}{spaCy}, \href{https://textblob.readthedocs.io/en/dev/}{TextBlob}), and high-level ML frameworks (\href{https://github.com/huggingface/transformers}{HuggingFace Transformers} and \href{https://huggingface.co/docs/diffusers/index}{Diffusers}, \href{https://keras.io/}{Keras}, \href{https://scikit-learn.org/stable/}{Scikit-Learn}, \href{https://github.com/google/trax}{Trax}).
    
    \item Expert knowledge of data and ML engineering tools and frameworks:
    
    \begin{itemize}
        \item \textbf{AutoML} - 
            \href{https://auto.gluon.ai/}{AutoGluon},
            \href{https://autokeras.com/}{AutoKeras}
            \href{https://github.com/Microsoft/nni}{NNI}
        \item \textbf{Data \& Model Versioning} - 
            \href{https://dvc.org/}{DVC}, 
            \href{https://git-lfs.github.com/}{Git-LFS}
        ...
        \item \textbf{Data Processing} - 
            ...
            \href{https://spark.apache.org/}{Spark} 2.x and 3.x
        \item \textbf{Data Visualization} - 
            \href{https://bokeh.org}{Bokeh}, 
            \href{https://github.com/plotly/dash}{Dash},
            \href{https://github.com/PAIR-code/facets}{Facets}
        \item \textbf{Feature Storage} - 
            \href{https://aws.amazon.com/sagemaker/feature-store/}{Amazon SageMaker Feature Store},
            \href{https://feast.dev/}{Feast}
        \item \textbf{Hyperparameter Tuning} -
            \href{https://github.com/scikit-optimize/scikit-optimize}{Scikit-Optimize},
            \href{https://github.com/autonomio/talos}{Talos},
            \href{https://docs.ray.io/en/latest/tune/index.html}{Tune}
        \item \textbf{ML Platforms} - 
            \href{https://www.dataiku.com/}{Dataiku}, 
            \href{https://www.kubeflow.org/}{Kubeflow}, 
            \href{https://www.tensorflow.org/tfx}{TFX}
        \item \textbf{Model Interpretability} - 
            \href{https://github.com/SeldonIO/alibi}{Alibi},
            \href{https://github.com/tensorflow/lucid}{Lucid} 
        \item \textbf{Model Lifecycle} - 
            \href{https://mlflow.org/}{MLflow}
        \item \textbf{Model Serialisation} - 
            \href{https://onnx.ai/}{ONNX}
        \item \textbf{Model Serving} - 
            %\href{https://docs.bentoml.org/en/latest/}{BentoML},
            \href{https://www.tensorflow.org/tfx/guide/serving}{TensorFlow Serving},
            \href{https://pytorch.org/serve/}{TorchServe}
            \href{https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/index.html}{Triton Inference Server}
        \item \textbf{Model Monitoring} - 
            \href{https://github.com/evidentlyai/evidently}{Evidently},
            \href{https://neptune.ai/}{Neptune}
        \item \textbf{Optimization Tools} - 
            \href{https://dask.org/}{Dask}, 
            \href{https://mahout.apache.org/}{Mahout}
        \item \textbf{Simplification Tools} - 
            \href{https://github.com/a3data/hermione}{Hermione},
            \href{https://github.com/ludwig-ai/ludwig}{Ludwig}
        \item \textbf{Visual Analysis and Debugging} - 
            \href{https://github.com/uber/manifold}{Manifold},
            \href{https://github.com/lutzroeder/netron}{Netron},
            \href{https://github.com/DistrictDataLabs/yellowbrick}{Yellowbrick}
    \end{itemize}
\end{itemize}
...
\section{Honors \& Awards}
  \resumeSubHeadingListStart
    ...
    Quantum computing hackathon organized by \href{https://quantum-computing.ibm.com/}{IBM Quantum} dedicated to \href{https://quantum-computing.ibm.com/services/programs/docs/runtime/manage/systems/dynamic-circuits/Introduction-To-Dynamic-Circuits}{dynamic circuits}.
    
    For more information, check out the \href{https://research.ibm.com/blog/quantum-challenge-spring-2023}{official announcement} on the IBM research blog.
    \vspace{2mm}
    \resumeSubheading
      {\href{https://simoninithomas.github.io/deep-rl-course/}{Hugging Face \emoji{hugging-face} Deep Reinforcement Learning Course} - Certificate of Excellence}{2023}
      {Hugging Face}{}
    \vspace{3mm}

    Online course organized by \href{https://huggingface.co/}{Hugging Face} covering beginner- to expert-level topics on Deep RL. Certificates of excellence were issued to all participants that passed \textbf{all} assignments before the end of April 2023.
    
    For more information, check out the \href{https://huggingface.co/blog/deep-rl-intro}{official announcement} on the Hugging Face \emoji{hugging-face} blog.
    \vspace{2mm}
    \resumeSubheading
    ...
    Space-themed, quantum computing hackathon organized by \href{https://quantum-computing.ibm.com/}{IBM Quantum}.
    
    Exercises included an exploration of primitives using the new \href{https://qiskit.org/documentation/partners/qiskit_ibm_runtime/}{Qiskit Runtime}, applying error mitigation techniques like \href{https://github.com/Qiskit-Partners/mthree}{matrix-free measurement mitigation} (M3) to ML problems involving quantum kernels, implementing \href{https://arxiv.org/abs/2006.05643}{problem-specific parameterized quantum circuits} to solve the traveling salesman problem, and the application of quantum chemistry techniques to study the \href{https://pubs.rsc.org/en/content/chapterhtml/2017/bk9781782627760-00001?isbn=978-1-78262-776-0}{interstellar medium} by computing the reaction energy of $H^+_3$, the first \href{https://arxiv.org/abs/1805.08138}{excited state} and dipole moment of $C_3 H_2$ (\href{https://pubmed.ncbi.nlm.nih.gov/11542419/}{Cyclopropenylidene}), and the interstellar chain reaction energy of \href{https://pubs.acs.org/doi/10.1021/jp020310z}{$C + C_2 H_2 \rightarrow C_3 H_2$}.
    
    For more information, check out the \href{https://research.ibm.com/blog/quantum-challenge-fall-2022}{official announcement} on the IBM research blog.
    \vspace{2mm}
    \resumeSubheading
    ...
    Internal \href{https://auto.gluon.ai/stable/index.html}{AutoGluon} competition promoted by \href{https://aws.amazon.com/machine-learning/mlu/}{Machine Learning University} (MLU) as part of the \emph{AutoGluon: Beyond the Basics} workshop - the goal was to create a model for binary classification on a multimodal setting (image, text, and tabular data).
    ...
    Quantum machine learning hackathon hosted by \href{https://www.xanadu.ai/}{Xanadu} and multiple sponsors.
    
    Won 400\$ in credits for AWS and access to an \href{https://www.ibm.com/quantum-computing/systems/}{IBM Quantum}'s 7-qubit device.
    
    {\tiny (*) Due to conflicting engagements, participation in the Coding Challenge was only active during the 1$^{st}$ week.}
    ...
    Quantum computing hackathon organized by IBM to celebrate the 40-year anniversary of the \emph{Physics of Computation} conference, and 5-year anniversary of \href{https://quantum-computing.ibm.com/}{IBM Quantum}.
    
    Exercises included factoring small integers with Shor's algorithm, running spectroscopy experiments against \emph{real} IBM Quantum systems (w/ exclusive access to the brand new \texttt{IBMQ Jakarta}) using \href{https://qiskit.org/documentation/apidoc/pulse.html}{Qiskit Pulse} and determining the ground state energy of small molecules (\texttt{H}$_2$, \texttt{LiH}) using \href{https://qiskit.org/textbook/ch-applications/vqe-molecules.html}{VQE}.
    
    For more information, check out the \href{https://research.ibm.com/blog/quantum-challenge-2021}{official announcement} on the IBM research blog.
    \vspace{2mm}
    \resumeSubheading
      {\href{https://www.udacity.com/bertelsmann-tech-scholarships}{Udacity Technology Scholarship} - \href{https://sites.google.com/udacity.com/bertelsmann-tech-scholarship/ai-track}{AI Track}}{2021}
      {Udacity / Bertelsmann}{}
    \vspace{3mm}
    
    Full scholarship to attend Udacity's \href{https://www.udacity.com/course/ai-product-manager-nanodegree--nd088}{AI Product Manager} nanodegree.
    \vspace{2mm}
    \resumeSubheading
    ...
    Quantum machine learning hackathon hosted by \href{https://aws.amazon.com/}{AWS} and \href{https://www.xanadu.ai/}{Xanadu}.
    
    Won 250\$ in credits for AWS and early access to an alpha version of Sandbox@Alphabet's \href{https://venturebeat.com/2021/03/10/alphabet-is-repurposing-google-tpus-for-quantum-computing-simulations/}{Floq simulator} \emoji{parrot} - a quantum SaaS API built on top of TPUs.

    For more information, read my \textit{\href{https://medium.com/@joao.galego/qhack-recap-pennylane-amazon-braket-and-beyond-a2c153d50a88}{QHack Recap - PennyLane, Amazon Braket and Beyond}} article on Medium.
    \vspace{2mm}
    \resumeSubheading
    ...
    Built an application based on \href{https://aws.amazon.com/sagemaker/}{Amazon SageMaker} in collaboration with \href{https://www.sbb.ch/}{\emph{Swiss Federal Railways} (SBB)} \emoji{train} to predict the \emph{traffic volume} and \emph{modal split} for a specific weather constellation and time based on a large set of real-world data points.
    \vspace{2mm}
    \resumeSubheading
    ...
    Scholarship for undergraduate students to work at the \href{http://cftp.ist.utl.pt/}{\emph{Center for Theoretical Particle Physics} (CFTP)}.
  \resumeSubHeadingListEnd
...
\section{Talks \& Events}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\href{https://pages.awscloud.com/InitiatePortugal_2022.html}{AWS Initiate Portugal 2022}}{}
    \vspace{3mm}
    ...
    \resumeSubheading
      ...
      {\href{http://wbme.fc.ul.pt/}{12th Workshop on Biomedical Engineering (WBME)}}{}
    \vspace{3mm}
...
\section{Languages}
  %\texttt{Deutsch} (elementary proficiency), 
  \texttt{English} (full professional proficiency), 
  \texttt{Español} (professional working proficiency), 
  \texttt{Français} (professional working proficiency), 
  \texttt{Italiano} (elementary proficiency), 
  \texttt{Português} (native)
